...
// Invoke function.
func Invoke(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
...
func Init(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
...
func add_test_data(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
...
func add_user(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var item data.User
	err := json.Unmarshal([]byte(args[1]), &item)
	if err != nil { return nil, err }
	return nil, data.Save(stub, item)
}
func add_thing(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var item data.Thing
	err := json.Unmarshal([]byte(args[1]), &item)
	if err != nil { return nil, err }
	return nil, data.Save(stub, item)
